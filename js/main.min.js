                ...
                if (logs.headers) {
                   ...
                   console.log(file);
                    ...
                    for (var b in logs.headers){ 
                        ...
                        $("#chooseColumn").append("<li><input type=checkbox onclick=myFunc('"+file+"','"+logs.headers[b]+"') value='"+logs.headers[b]+ "'/>"+logs.headers[b]+"</li> ");
                        if (file in store){
                            if (logs.headers[b] in store[file]){
                                if (store[file][logs.headers[b]])
                                    $("#chooseColumn input[value="+logs.headers[b]+"]").prop('checked', true);
                            }else{
                                store[file][logs.headers[b]]=0;
                            }
                        }else{
                            store[file]={};
                            store[file][logs.headers[b]]=0;
...
//              console.log("unchkd" + title);
//              $('span[title="' + title + '"]').remove();
        console.log("value " + value +" file "+file);
        store[file][value]=1;
        if (count>1){
            $('span[title="' + title + '"]').remove();
            console.log(count);
          count--;
            ...
            count=0;
            $('span[title="' + title + '"]').remove();
            var html = '<span title="' + "Select" + '">' + "Select" + '</span>';
              $('.multiSel').append(html);
//                     $(".hida").hide();
        }
//              var ret = $(".hida");
